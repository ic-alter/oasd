...
CREATE TABLE `paintinggenres` (
  `PaintingGenreID` int NOT NULL AUTO_INCREMENT,
  `PaintingID` int DEFAULT '0',
...
) ENGINE=InnoDB AUTO_INCREMENT=696 DEFAULT CHARSET=utf8mb3;
...
INSERT INTO `paintinggenres` VALUES ('693', '608', '94');
...
CREATE TABLE `paintings` (
  ...
  KEY `Title` (`Title`),
  KEY `PaintingID` (`PaintingID`)
) ENGINE=InnoDB AUTO_INCREMENT=611 DEFAULT CHARSET=utf8mb3;

-- ----------------------------
-- Records of paintings
-- ----------------------------
INSERT INTO `paintings` VALUES ('5', '1', '20', '001050.jpg', 'Self-portrait (Yo)', '1', 'http://www.moma.org/collection/works/80026?locale=en', '587.1998', 'Estate of Pablo Picasso / Artists Rights Society', null, null, '1901', '54', '32', 'Oil on cardboard on panel', '125.0000', '135.0000', '2022-05-24 19:00:17', '2022-05-26 00:50:01', null, '29', '0');
INSERT INTO `paintings` VALUES ('7', '1', '7', '001080.jpg', 'Family of Saltimbanques', '3', 'http://www.nga.gov/content/ngaweb/Collection/art-object-page.46665.html', '1963.10.190', 'Estate of Pablo Picasso/Artists Rights Society', '<em>Family of Saltimbanques</em> (La famille de saltimbanques) is a 1905 painting by Pablo Picasso. It is considered the masterpiece of Picasso\'s circus period. The painting depicts six saltimbanques, a kind of itinerant circus performer, in a desolate landscape. The composition groups them together, but they do not seem connected to each other and are not looking at each other.[', '<em>Family of Saltimbanques</em> (La famille de saltimbanques) is a 1905 painting by Pablo Picasso. It is considered the masterpiece of Picasso\'s circus period.', '1905', '213', '230', 'Oil on canvas', '440.0000', '570.0000', '2022-05-24 19:00:34', '2022-05-26 00:50:01', 'icalter', '37', '0');
...
INSERT INTO `paintings` VALUES ('57', '19', '52', '019010.jpg', 'Self Portrait', '1', 'http://www.dia.org/object-info/662cf867-c9e6-4f6b-9281-8b5ca7dd6c72.aspx', '22.13', '&copy; Detroit Institute of Arts', null, null, '1887', '35', '27', 'Oil on canvas', '420.0000', '550.0000', '2022-05-24 19:00:34', '2022-05-26 00:50:01', null, '0', '0');
...
INSERT INTO `paintings` VALUES ('67', '20', '19', '020070.jpg', 'Circus', '1', 'http://www.musee-orsay.fr/en/collections/works-in-focus/search/commentaire/commentaire_id/cirque-7090.html', 'RF 2511', '&copy; Home', null, null, '1891', '185', '152', 'Oil on canvas', '450.0000', '500.0000', '2022-05-24 19:00:34', '2022-05-26 00:50:01', null, '1', '0');
...
INSERT INTO `paintings` VALUES ('608', '147', null, '24608.PNG', '触手1145', null, null, null, 'Public domain', '烧鸡', null, '2012', '1', '1', 'Oil on canvas', '123.3450', '900.0000', '2022-05-25 15:32:51', '2022-05-26 00:50:01', 'icalter', '4', '0');
...
INSERT INTO `paintings` VALUES ('610', '149', null, '24610.PNG', '水月和澄闪', null, null, null, 'Public domain', 'mizuki天下第一可爱！', null, '2013', '13', '23', 'Oil on canvas', '1919810.8888', '900.0000', '2022-05-26 01:03:05', '2022-05-26 01:03:05', 'mizuki', '5001', '0');
...
CREATE TABLE `paintingsubjects` (
  `PaintingSubjectID` int NOT NULL AUTO_INCREMENT,
  `PaintingID` int DEFAULT '0',
  `SubjectID` int DEFAULT '11',
...
CREATE TABLE `shoppingcart` (
  ...
  `PaintingID` int DEFAULT '0',
  `username` varchar(255) DEFAULT NULL,
  `EntryingTime` datetime DEFAULT NULL,
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'icalter', 'icalter', '114514', '13706303326', '1600224799@qq.com', '1234', '0.0000');
INSERT INTO `user` VALUES ('2', 'mizuki', '水月', '1919810', '15269265778', '2818259462@qq.com', '伊比利亚', '0.0000');
